...
| `Experiment1.3-LGD` | Headline LGD benchmark, same structure: **R²** and **Pearson correlation** in three views, **R² rank**, **HPO effect**, **time analysis**, the **TabPFN v3 vs CatBoost** head-to-head (R²), and a summary table. |
